...
function main() {
  ...
  // Journal rows must be cleared before personnel IDs are reused. Preserving
  // them across a destructive demo reset could attach private writing to a
  // different generated person.
  for (const t of ['journal_entries', 'users', 'units', 'personnel', 'hr_events', 'checkins', 'assessments', 'risk_scores', 'alerts', 'interventions', 'audit_log', 'data_corrections', 'sessions'])
