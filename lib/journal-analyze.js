...
const TOPICS = [
  { emoji: '🏆', label: 'Success',   color: '#16a085', words: ['work','job','career','success','business','project','projects','goal','goals','achieve','achievement','promotion','deadline','meeting','boss','office','professional','productivity','productive','client','milestone','finished','shipped'] },
