...
const RULES = [
  ...
  { when: 'engagement',    rec: { type: 'peer_support',       reason: 'Low wellness engagement — assign peer-support buddy check-in' } },
  { when: 'disciplinary',  rec: { type: 'peer_support',       reason: 'Welfare touch-base recommended alongside any disciplinary process' } }
];
